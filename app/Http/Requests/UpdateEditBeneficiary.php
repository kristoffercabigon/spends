...
class UpdateEditBeneficiary extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'email' => [
                'required',
                'email',
                Rule::unique('seniors')->ignore($seniorId),
            ],
            ...
            "valid_id" => 'mimes:jpeg,png,bmp,tiff|max:4096',
            "profile_picture" => 'nullable|mimes:jpeg,png,bmp,tiff|max:4096',
            "indigency" => 'mimes:jpeg,png,bmp,tiff|max:4096',
            "birth_certificate" => 'mimes:jpeg,png,bmp,tiff|max:4096',
