        ...
        <div class="w-full mx-auto font-[poppins]">
            <div class="bg-white mb-4 mt-4 ml-4 mr-4 rounded-md">              
                <div class="px-6 py-4 lg:px-12">
                    <form id="form" action="{{route('admin-submit-add-beneficiary')}}" enctype="multipart/form-data" method="POST" class="w-full bg-white rounded-md">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                            <div x-data="{
                                ...
                                previewAdminApplicantValidIDUrl: '', // Corrected to use 'validIdPreviewUrl'
                                previewValidIdImage(event) {
                                    const input = event.target;
                                    if (input.files && input.files[0]) {
                                        const reader = new FileReader();
                                        reader.onload = (e) => {
                                            this.previewAdminApplicantValidIDUrl = e.target.result; // Correct variable name
                                ...
                                <div class="flex justify-center items-center mt-4">
                                    <img :src="previewAdminApplicantValidIDUrl" id="valid_id_preview" class="animate-blurred-fade-in max-h-48 rounded-md shadow-lg cursor-pointer" 
                                        style="display: none;" alt="Valid ID Preview" @click="showAdminApplicantValidIDModal = true">
                                </div>
                            ...
                            <div x-data="{
                                    ...
                                    previewAdminApplicantProfilePicUrl: '',
                                    previewImage(event) {
                                        const input = event.target;
                                        if (input.files && input.files[0]) {
                                            const reader = new FileReader();
                                ...
                                <div class="flex justify-center items-center mt-4">
                                    <img :src="previewAdminApplicantProfilePicUrl" id="profile_picture_preview" class="animate-blurred-fade-in max-h-48 rounded-md shadow-lg cursor-pointer" style="display: none;" alt="Profile Picture Preview"
                            ...
                            <div x-data="{
                                    ...
                                    previewAdminApplicantIndigencyUrl: '',
                                ...
                                <div class="flex justify-center items-center mt-4">
                                    <img :src="previewAdminApplicantIndigencyUrl" id="indigency_preview" class="animate-blurred-fade-in max-h-48 rounded-md shadow-lg cursor-pointer" 
                                        style="display: none;" alt="Indigency Certificate Preview" @click="showAdminApplicantIndigencyModal = true">
                                </div>
                            ...
                            <div x-data="{
                                    ...
                                    previewAdminApplicantBirthCertificateUrl: '',
                                ...
                                <div class="flex justify-center items-center mt-4">
                                    <img :src="previewAdminApplicantBirthCertificateUrl" id="birth_certificate_preview" class="animate-blurred-fade-in max-h-48 rounded-md shadow-lg cursor-pointer" 
                                        style="display: none;" alt="Birth Certificate Preview" @click="showAdminApplicantBirthCertificateModal = true">
                                </div>
