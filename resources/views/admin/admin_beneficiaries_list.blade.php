...
<script>
    ...
    function updateTable(page) {
        ...
        fetch('/admin/filter-beneficiaries?page=' + page, {
            method: 'POST',
            headers: {
        ...
        const row = `
            <tr class="${index % 2 === 0 ? 'bg-[#ffece5]' : 'bg-[#ffc8b3]'}">
                ...
                <td class="px-3 py-2 flex justify-center items-center">
                    <a href="/admin/view-senior-profile/${senior.id}" class="bg-blue-500 animate-pop hover:bg-blue-600 rounded-md p-2 cursor-pointer">
                        <img src="../images/view-senior.png" alt="View Senior" class="w-4 h-4">
                    </a>
                    <a href="/admin/edit-senior-profile/${senior.id}" class="bg-orange-500 ml-1 animate-pop hover:bg-orange-600 rounded-md p-2 cursor-pointer">
