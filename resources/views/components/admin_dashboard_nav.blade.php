...
@endphp
    ...
    >
      <div class="flex fixed top-0 left-0 z-10 h-screen antialiased text-gray-900">
        ...
        <nav x-data="{
                AdmindashboarddropdownOpen: false,
            }"
            ...
            <div class="container max-w-screen-2xl flex items-center h-full w-full justify-between relative font-poppins">
                ...
                <div class="hidden md:block items-center">
                    @auth('admin')
                        ...
                        @endphp
                        <div class="flex items-center cursor-pointer relative" @click="AdmindashboarddropdownOpen = !AdmindashboarddropdownOpen">
                            ...
                            <div 
                                x-show="AdmindashboarddropdownOpen"
                                ...
                                style="display: none"
                                @click.away="AdmindashboarddropdownOpen = false"
                            ...
                            >
                                ...
                                <ul class="py-2 text-sm text-gray-700" aria-labelledby="avatarButton">
                                    <li>
                                        <a href="/admin" class="block px-4 py-2 hover:bg-gray-100 flex items-center">
                                        <img 
        ...
        <nav aria-label="Main" class="flex-1 animate-custom-fade-in-right bg-white w-64 px-2 py-4 space-y-2 z-20 overflow-y-hidden hover:overflow-y-auto mt-[80px]" 
        ...
        >  
          <div>
            <a
                ...
                role="menuitem"
                class="flex items-center p-2 mb-2 transition-colors duration-200 rounded-md 
                      hover:text-gray-700 hover:bg-primary-100 
                      {{ request()->is('admin/dashboard') ? 'text-gray-700 bg-primary-100' : 'text-gray-500' }}"
            >
                <img 
          ...
          <div>
              ...
              {{ request()->is('admin/application-requests') || request()->is('admin/application-requests/view-senior-profile/*') ? 'text-gray-700 bg-primary-100' : 'text-gray-500' }}"
              >
              <img 
          ...
          <div>
              ...
              role="menuitem"
              class="flex items-center p-2 mb-2 text-gray-500 transition-colors duration-200 rounded-md hover:text-gray-700 hover:bg-primary-100
              {{ request()->is('admin/activity-log') ? 'text-gray-700 bg-primary-100' : 'text-gray-500' }}"
              >
                <img 
          ...
          <div>
              ...
              role="menuitem"
              class="flex items-center p-2 mb-2 text-gray-500 transition-colors duration-200 rounded-md hover:text-gray-700 hover:bg-primary-100
              {{ request()->is('admin/sign-in-history') ? 'text-gray-700 bg-primary-100' : 'text-gray-500' }}"
              >
                <img 
          ...
          <div>
              ...
              role="menuitem"
              class="flex items-center p-2 mb-2 text-gray-500 transition-colors duration-200 rounded-md hover:text-gray-700 hover:bg-primary-100
              {{ request()->is('admin/encoders') || request()->is('admin/encoders/view-encoder-profile/*') ? 'text-gray-700 bg-primary-100' : 'text-gray-500' }}"
              >
                <img 
                    src="{{ asset('images/user.png') }}" 
                    alt="Dashboard Icon" 
          ...
          <div x-data="{ isActive: false, open: false}">
            ...
            <div role="menu" x-show="open" class="mt-2 animate-custom-fade-in-right space-y-2 px-7" aria-label="Dashboards">
              <a
                ...
                role="menuitem"
                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md hover:text-gray-700 {{ request()->is('admin/pension-distribution-list') ? 'text-gray-700 bg-primary-100' : 'text-gray-500' }}"
              >
        ...
        >
            ...
            <div class="relative flex items-center justify-center flex-shrink-0">
              ...
              <div class="" x-data="{ open: false }">
                ...
                <div class="px-4 py-2 text-sm text-gray-900">
                  ...
                  <a
                      role="menuitem"
                      class="block px-4 py-2 text-sm text-gray-700 cursor-pointer transition-colors hover:bg-gray-100 flex items-center"
                  >
                      <form action="/admin/logout" method="POST">
                          @csrf
          ...
          x-show="isMainPanelOpen" style="display: none"
          tabindex="-1"
