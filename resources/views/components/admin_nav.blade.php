        ...
        <div class="hidden md:block items-center">
            @auth('admin')
                ...
                <div class="flex items-center cursor-pointer relative" @click="AdmindropdownOpen = !AdmindropdownOpen">
                    <img id="avatarButton" class="w-10 h-10 rounded-full ring-2 ring-white" src="{{ $admin->admin_profile_picture ? asset('storage/images/admin/admin_profile_picture/'.$admin->admin_profile_picture) : $default_profile }}" alt="Profile Picture">
                    <div class="ml-4">
