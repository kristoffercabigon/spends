@if(session()->has('admin-message-header') || session()->has('admin-message-body'))
<div x-data="{ show: true }" 
  ...
  <div class="flex">
    ...
    <div>
      <p id="admin-message-header" class="font-bold">{{ session('admin-message-header') }}</p>
      <p id="admin-message-body" class="text-sm">{{ session('admin-message-body') }}</p>
    </div>  
  </div>
</div>
@endif
