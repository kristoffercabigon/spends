...
<div x-data="{ show: true }" 
  ...
  <div class="flex">
    ...
    <div>
      <p id="encoder-error-message-header" class="font-bold">{{ session('encoder-error-message-header') }}</p>
      <p id="encoder-error-message-body" class="text-sm">{{ session('encoder-error-message-body') }}</p>
    </div>  
  </div>
</div>
@endif
