@if(session()->has('error-message-header') || session()->has('error-message-body'))
<div x-data="{ show: true }" 
  ...
  <div class="flex">
    ...
    <div>
      <p id="error-message-header" class="font-bold">{{ session('error-message-header') }}</p>
      <p id="error-message-body" class="text-sm">{{ session('error-message-body') }}</p>
    </div>  
  </div>
</div>
@endif
