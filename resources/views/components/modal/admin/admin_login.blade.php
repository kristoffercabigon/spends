...
<div style="display: none" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30 font-poppins"
    ...
    <div @click.stop>
        <section class="bg-gray-50 relative">
            <button @click="showAdminLoginModal = false; localStorage.setItem('showAdminLoginModal', 'false')" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700 focus:outline-none">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form x-data="{ isAdminLoadingSignIn: false }" 
                        ...
                        <div>
                            ...
                            <input type="email" name="admin_email" id="admin_email" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="email@example.com">
