<div x-show="showEncoderApplicantBirthCertificateModal" style="display: none"
     ...
     @click.away="showEncoderApplicantBirthCertificateModal = false"
     x-data="{ 
         zoom: 1, 
         isDragging: false, 
         dragStartX: 0, 
    ...
    <div @click.stop class="bg-white mx-4 rounded-lg overflow-hidden shadow-xl transform transition-all max-w-3xl w-full relative">
        <section class="p-4 bg-gray-50">
            ...
            <button type="button" @click="showEncoderApplicantBirthCertificateModal = false" 
                    class="absolute top-4 right-4 z-40 focus:outline-none">
                <img src="../../../images/close.png" alt="Close" class="h-6 w-6">
            </button>

            <div class="flex justify-center p-6">
                <img :src="previewEncoderApplicantBirthCertificateUrl" alt="Enlarged Profile Picture Preview" 
