            ...
            <div class="w-[400px] bg-white rounded-lg shadow sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <ul class="grid grid-cols-2 mx-auto py-2 gap-x-4 md:gap-x-8 w-[100%] relative z-10">
                            <div class="flex flex-col items-center gap-y-2">
                                <li id="navstep1" class="flex flex-col items-center gap-y-2 group">
                                    ...
                                    <span class="text-sm font-medium text-gray-800">Basic Information</span>
                                </li>
                            </div>
                    ...
                    <form x-data="{ isEncoderLoadingSignUp: false }"
                          ...
                          $nextTick(() => $el.submit());" 
                          class="space-y-4 md:space-y-6" method="POST" enctype="multipart/form-data" action="/encoder/edit-profile">
                        @method('PUT')
                        @csrf
                        ...
                        <div id="content2" class="space-y-4 px-2 md:space-y-6 overflow-x-hidden overflow-y-auto max-h-80 px-2">
                            ...
                            <label for="encoder_profile_picture" class="text-gray-700 text-xs mt-2">Current Profile Picture</label>
                                <div class="items-center justify-center flex mt-4">
                                    <img src="{{ asset('storage/images/encoder/encoder_profile_picture/' . $encoder->encoder_profile_picture) }}" alt="Current Profile Picture" class="max-h-48 rounded-md shadow-lg">
                                </div>
                            @endif
                        ...
                        <div class="mt-3  flex justify-between items-center">
                            <div>
                                <button type="button" id="backButton" class="hover:animate-scale py-3 px-6 shadow-lg text-sm tracking-wider font-light rounded-md text-gray-800 border border-gray-200 bg-gray-200 shadow-sm hover:bg-gray-300 focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
