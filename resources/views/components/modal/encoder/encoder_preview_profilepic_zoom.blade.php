<div x-show="showEncoderPreviewProfilePicModal" style="display: none"
         ...
         @click.away="showEncoderPreviewProfilePicModal = false"
         x-data="{ 
             zoom: 1, 
             isDragging: false, 
             dragStartX: 0, 
        ...
        <div @click.stop class="bg-white mx-4 rounded-lg overflow-hidden shadow-xl transform transition-all max-w-3xl w-full relative">
            <section class="p-4 bg-gray-50">
                ...
                <div class="flex justify-center p-6">
                    <img :src="previewUrl1" alt="Enlarged Profile Picture Preview" 
