<div x-show="showEncoderProfilePicModal" style="display: none"
     ...
     @click.away="showEncoderProfilePicModal = false"
     x-data="{ 
         zoom: 1, 
         isDragging: false, 
         dragStartX: 0, 
    ...
    <div @click.stop class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-3xl w-full relative">
        <section class="p-4 bg-gray-50">
            ...
            <button type="button" @click="showEncoderProfilePicModal = false" 
