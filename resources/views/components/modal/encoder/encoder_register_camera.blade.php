<div x-show="showEncoderCameraModal" style="display: none" class="fixed inset-0 bg-black bg-opacity-50 z-30 flex items-center justify-center z-30 font-poppins" 
    ...
    <div @click.stop class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
        <section class="bg-gray-50 dark:bg-gray-900 relative">
            <button type="button" @click="showEncoderCameraModal = false" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 focus:outline-none">
                ...
                <div class="col">
                    <div class="col-md-6">
                        <div class="relative w-full h-auto">
                            <div id="my_encoder_camera" class="w-full h-auto"></div>
                    ...
                    <div class="col-md-6 text-center text-gray-900">
                        <div id="encoder_image_results">(Your captured image will appear here)</div>
                    </div>
    ...
    function useEncoderCapturedPhoto() {
        ...
        fetch(imageData)
            ...
            .then(blob => {
                ...
                document.dispatchEvent(new CustomEvent('close-encoder-camera-modal', { bubbles: true }));
            });
    }

    document.addEventListener('close-encoder-camera-modal', function() {
        Alpine.store('showEncoderCameraModal', false); 
    });
</script>
