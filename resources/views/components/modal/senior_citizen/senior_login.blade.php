...
<div x-show="showLoginModal" style="display: none" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30 font-poppins"
    ...
    <div @click.stop>
        <section class="bg-gray-50 relative mx-4 rounded-lg">
            <button @click="showLoginModal = false; localStorage.setItem('showLoginModal', 'false')" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700 focus:outline-none">
