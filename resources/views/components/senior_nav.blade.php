...
<nav x-data="{ open: false, dropdownOpen: false, showLoginModal: localStorage.getItem('showLoginModal') === 'true' }" class="bg-customGreen fixed h-[80px] w-full z-20 top-0 left-0 right-0 text-white shadow-2xl">
