        ...
        <div class="max-w-md w-full bg-white shadow-lg rounded-lg p-8">
            ...
            <div style="background-color: #fff; padding: 20px; text-align: center; justify-content: center; align-items: center;">
                ...
                <p style="font-size: 18px; color: #4a5568; margin-bottom: 24px;">
                    There have been five unsuccessful login attempts to your account using the encoder email address:
                </p>
                ...
                <p style="font-size: 18px; color: #4a5568; margin-bottom: 24px;">
                    This login attempt was recorded on {{ $encoder_throttleTime }} from the IP address {{ $encoder_ipAddress }}.
                </p>
