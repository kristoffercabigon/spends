        ...
        <div class="max-w-md w-full bg-white shadow-lg rounded-lg p-8">
            ...
            <div style="background-color: #fff; padding: 20px; text-align: center;">
                ...
                <div class="flex items-center justify-center mb-6">
                    <a href="http://localhost:8000/encoder/reset-password?encoder_token={{ $encoder_token }}&encoder_email={{ urlencode($encoder_email) }}" style="display: inline-block; max-width: 50%; background-color: #ff4802; color: white; padding: 10px 20px; border-radius: 5px; font-size: 25px; text-decoration: none; font-weight: bold; overflow-wrap: break-word;">
                        {{ $encoder_token }}
                    </a>
                </div>
                <p style="font-size: 18px; color: #4a5568; margin-bottom: 24px;">
