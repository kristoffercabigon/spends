        ...
        <div class="max-w-md w-full bg-white shadow-lg rounded-lg p-8">
            ...
            <div style="background-color: #fff; padding: 20px; text-align: center; justify-content: center; align-items: center;">
                ...
                <div class="text-center mb-6">
                    <a href="{{ $verificationLink }}" style="display: inline-block; background-color: #ff4802; color: white; padding: 10px 20px; border-radius: 5px; font-size: 18px; text-decoration: none; font-weight: bold;">
                        Verify Email
                    </a>
                </div>
