        ...
        <div class="w-full mx-auto font-[poppins]">
            <div class="bg-white mb-4 mt-4 ml-4 mr-4 rounded-md">              
                <div class="px-6 py-4 lg:px-12">
                    <form id="form" action="{{ route('encoder-submit-edit-beneficiary', ['senior' => $senior->id]) }}" enctype="multipart/form-data" method="POST" class="w-full bg-white rounded-md">
                    @method('PUT')
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                            ...
                            <div x-data="{
                                    ...
                                    previewEncoderApplicantValidIDUrl: '{{ $valid_id_url }}',
                                ...
                                <div class="flex justify-center items-center mt-4">
                                    <img :src="previewEncoderApplicantValidIDUrl" id="valid_id_preview" 
                            ...
                            <div x-data="{
                                    ...
                                    previewEncoderApplicantProfilePicUrl: '{{ $profile_picture_url }}',
                                    previewImage(event) {
                                        const input = event.target;
                                        if (input.files && input.files[0]) {
                                            const reader = new FileReader();
                                ...
                                <div class="flex justify-center items-center mt-4">
                                    <img :src="previewEncoderApplicantProfilePicUrl" id="profile_picture_preview" class="animate-blurred-fade-in max-h-48 rounded-md shadow-lg cursor-pointer" 
                            ...
                            <div x-data="{
                                    ...
                                    previewEncoderApplicantIndigencyUrl: '{{ $indigency_url }}',
                                ...
                                <div class="flex justify-center items-center mt-4">
                                    <img :src="previewEncoderApplicantIndigencyUrl" id="indigency_preview" 
                                        class="animate-blurred-fade-in max-h-48 rounded-md shadow-lg cursor-pointer" 
                            ...
                            <div x-data="{
                                    ...
                                    previewEncoderApplicantBirthCertificateUrl: '{{ $birth_certificate_url }}',
                                ...
                                <div class="flex justify-center items-center mt-4">
                                    <img :src="previewEncoderApplicantBirthCertificateUrl" id="birth_certificate_preview" 
                                        class="animate-blurred-fade-in max-h-48 rounded-md shadow-lg cursor-pointer" 
