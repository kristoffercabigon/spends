                    ...
                    <div class="grid mb-4 grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex relative justify-start md:justify-end">
                                <button 
                                @click.prevent="showEncoderAddPensionDistributionModal = true; localStorage.setItem('showEncoderAddPensionDistributionModal', 'true')"
...
<script>
    ...
    function updateTable(page) {
        ...
        fetch('/encoder/pension-distribution-list/filter-pension-distribution-list?page=' + page, {
            method: 'POST',
            headers: {
