    ...
    <div class="bg-white bg-opacity-50 min-h-screen flex items-center justify-center font-poppins">
        <div class="w-full max-w-7xl mx-auto font-[poppins]">
            <div class="bg-white mt-4 shadow-lg rounded-md">              
                <div class="w-full my-5 p-5 px-12 py-10">
                        ...
                        <div class="md:flex no-wrap ">
                            <div class="w-full md:w-3/12 md:mx-2">
                                <div class="bg-white p-3 shadow-md border-t-4 border-b-4 rounded-md border-gray-400">
                                    ...
                                    <button 
                                        type="button" 
                                        class="hover:animate-scale py-3 px-4 md:w-auto text-sm cursor-pointer tracking-wider font-light rounded-md text-white bg-[#1AA514] hover:bg-[#148410] focus:outline-none mt-4 w-full" 
