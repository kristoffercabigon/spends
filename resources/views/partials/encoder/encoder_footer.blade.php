<footer class="flex flex-col w-full relative items-center bg-[#FF4802] text-center shadow-lg text-surface">
  ...
  <div class="container pt-16">
    <div class="mb-6 flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-10">
        <a href="/encoder" class="text-white hover:text-orange-300 hover:scale-105 transition duration-150 ease-in-out">Home</a>
        <a href="/encoder/about-us" class="text-white hover:text-orange-300 hover:scale-105 transition duration-150 ease-in-out">About Us</a>
    </div>
