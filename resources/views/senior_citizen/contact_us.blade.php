                ...
                <div class="w-full mb-16 mt-5 p-5 px-6 py-10 md:px-12">
                    ...
                    <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-white rounded-lg">
                        <div class="grid lg:grid-cols-2 items-center gap-14">
                            <div class="mx-4">
                                <h1 class="text-4xl font-bold" style="color: #FF4802;">Get in Touch</h1>
                                <p class="text-sm text-gray-600 mt-4 leading-relaxed">Need assistance or more information? We’re here to help. Reach out to us, and we’ll be glad to assist with your inquiries.</p>

                                 <div class="grid grid-cols-2 gap-4 block lg:left-16 max-lg:px-4 mt-6">
                                    <div class="flex flex-col shadow-md items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] hover:animate-scale p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-orange-200 focus:outline-none focus:ring-0">
                            ...
                            <div class="bg-[#ffece5] p-6 rounded-lg">
                                <form class="mt-8 space-y-4">
                                    ...
                                    <button type='button'
                                        class="text-white bg-[#1AA514] hover:bg-[#148410] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
