                ...
                <div class="w-full mb-16 mt-5 p-5 px-6 py-10 md:px-12">
                    ...
                    <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-white rounded-lg">
                        <div class="grid lg:grid-cols-2 items-center gap-14">
                            ...
                            <div id="InputForm" class="bg-[#ffece5] p-6 rounded-lg hover:ring-1 hover:ring-[#FF4802] hover:shadow-xs hover:shadow-[#FF4802] transition-all">
                                <form class="mt-8 space-y-4" method="POST" action="/contact-us/send-message">
                                    @csrf
                                    ...
                                    <textarea name="message" placeholder="Message" rows="6"
                                        class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#a91079]" required></textarea>
                                    <button type="submit"
                                        class="text-white bg-[#1AA514] hover:bg-[#148410] hover:animate-pop tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
