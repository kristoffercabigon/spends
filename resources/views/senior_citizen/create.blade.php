            ...
            <div class="mx-4">
                ...
                <div class="mt-8 relative sm:mt-8">
                    ...
                    <form id="form" action="/store" enctype="multipart/form-data" method="POST" class="shadow-lg font-poppins" >
                        <div id="content2" class="w-full bg-white max-h-[80vh] shadow-lg mt-[-17px] overflow-y-auto sm:pt-2 px-6 py-10 rounded-md lg:px-12" style="display: none;">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                                <div class="relative">
                                    <label id="oscaMemberLabel" class="text-sm mt-4 mb-2 block text-gray-800">
                                        OSCA ID
                                    </label>
                                    <input 
                                        name="osca_id" 
                                        ...
                                        type="text" 
                                        value="{{ old('osca_id') }}" 
                                        class="w-full text-sm px-4 py-3 rounded-md transition-all pr-10 bg-gray-100 border-gray-500 focus:ring-blue-500 focus:border-blue-500" 
                                    ...
                                    <p id="oscaMemberMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="firstNameLabel" class="text-sm text-gray-800">
                                    ...
                                    <p id="firstNameMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <label id="middleNameLabel" class="text-sm mb-2 block text-gray-800">
                                    ...
                                    <p id="middleNameMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        <img id="last_name_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <label id="lastNameLabel" class="text-sm text-gray-800">
                                    ...
                                    <p id="lastNameMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <label for="suffix" id="suffixLabel" class="text-sm mb-2 block text-gray-800">
                                    ...
                                    <p id="suffixMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label for="birthdate" id="birthdateLabel" class="text-sm text-gray-800">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('birthdate') }}" 
                                    />
                                    <span id="birthdateIcon" class="absolute inset-y-0 right-0 flex items-center pr-3 top-1/2 transform -translate-y-1/2 hidden">
                                        <svg id="validIconBirthdate" class="w-5 h-5 text-green-500 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                        </svg>
                                        <svg id="invalidIconBirthdate" class="w-5 h-5 text-red-500 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                        </svg>
                                    </span>
                                    <p id="birthdateMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        <img id="age_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <label for="age" id="ageLabel" class="text-sm text-gray-800">
                                    ...
                                    <p id="ageMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        <img id="birthplace_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <label for="birthplace" id="birthplaceLabel" class="text-sm text-gray-800">
                                    ...
                                    <p id="birthplaceMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label for="sex_id" id="sexLabel" class="text-sm text-gray-800">
                                    ...
                                    <p id="sexMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        <img id="civil_status_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <label for="civil_status_id" id="civilStatusLabel" class="text-sm text-gray-800">
                                        Civil Status
                                        </label>                                        
                                    </div>
                                    <select name="civil_status_id" id="civil_status_id"
                                        class="w-full text-sm px-4 py-3 rounded-md transition-all 
                                    ...
                                    <p id="civilStatusMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        <img id="contact_no_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <label for="contact_no" id="contactNoLabel" class="text-sm text-gray-800">
                                        Contact Number
                                        </label>                                        
                                    </div>
                                    ...
                                    <div class="flex">
                                        ...
                                        <input 
                                            ...
                                            class="w-full text-sm px-4 py-3 rounded-r-md transition-all pr-10 bg-gray-100 border-gray-500 focus:ring-blue-500 focus:border-blue-500" 
                                    ...
                                    <p id="contactNoMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
                                <div class="md:col-span-3 relative">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="addressLabel" class="text-sm text-gray-800">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        value="{{ old('address') }}"
                                        class="bg-gray-100 focus:bg-transparent w-full text-sm px-4 py-3 rounded-md transition-all border-gray-500 focus:ring-blue-500 focus:border-blue-500"
                                        placeholder="Enter House No., Street, Barangay, City/Municipality, Province"
                                    />
                                    <span id="addressIcon" class="absolute inset-y-0 right-0 flex items-center pr-3 top-1/2 transform -translate-y-1/2 hidden">
                                    ...
                                    <p id="addressMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        <img id="barangay_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <label for="barangay_id" id="barangayLabel" class="text-sm text-gray-800">
                                        Barangay
                                        </label>
                                    </div>

                                    <select name="barangay_id" id="barangay_id"
                                        class="w-full text-sm px-4 py-3 rounded-md transition-all bg-gray-100 border-gray-500 focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    <span id="barangayIcon" class="absolute inset-y-0 right-0 flex items-center pr-3 top-1/2 transform -translate-y-1/2 hidden">
                                    ...
                                    <p id="barangayMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
                                <div class="relative md:col-span-3">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="livingArrangementLabel" class="text-sm text-gray-800">
                                        Living Arrangement
                                        </label>
                                    </div>
                                    ...
                                    <div class="relative mt-4">
                                        ...
                                        <label id="other_arrangement_remark_label" class="text-sm text-gray-800 mt-4 mb-2 block hidden"> 
                                            <div class="flex items-center ">
                                        ...
                                        <input 
                                            ...
                                            class="bg-gray-100 focus:bg-transparent w-full text-sm px-4 py-3 rounded-md transition-all border-gray-500 focus:ring-blue-500 focus:border-blue-500 hidden" 
                                            placeholder="Enter additional information" 
                                            value="{{ old('other_arrangement_remark') }}" 
                                            style="width: -webkit-fill-available;">
                                    </div>

                                    <p id="livingArrangementMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                        </div>

                        <div id="content3" class="w-full bg-white max-h-[80vh] shadow-lg mt-[-17px] overflow-y-auto sm:pt-2 px-6 py-10 rounded-md lg:px-12" style="display: none;">

                            <div class="text-sm mt-8 mb-8 text-gray-800 font-semibold">
                                <div class="flex items-center mt-4">
                                    <img src="images/warning.png" alt="Info Icon" class="w-4 h-4 mr-1">
                                    <p class="text-left">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                                <div class="relative">
                                    <label id="guardianFirstNameLabel" class="text-sm mb-2 block text-gray-800">
                                        First Name <span class="italic">(Unang Pangalan)</span>
                                    </label>
                                    <input 
                                    ...
                                    <p id="guardianFirstNameMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <label id="guardianMiddleNameLabel" class="text-sm mb-2 block text-gray-800">
                                        Middle Name <span class="italic">(Gitnang Pangalan)</span>
                                    </label>
                                    <input 
                                    ...
                                    <p id="guardianMiddleNameMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <label id="guardianLastNameLabel" class="text-sm mb-2 block text-gray-800">
                                        Last Name <span class="italic">(Huling Pangalan)</span>
                                    </label>
                                    <input 
                                    ...
                                    <p id="guardianLastNameMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <label id="guardianSuffixLabel" class="text-sm mb-2 block text-gray-800">
                                        Suffix <span class="italic">(Karugtong na Pangalan)</span>
                                    </label>
                                    <input 
                                    ...
                                    <p id="guardianSuffixMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                                <div class="relative">
                                    <label for="guardian_relationship_id" id="guardianRelationshipLabel" class="text-sm mb-2 block 
                                    ...
                                    <p id="guardianRelationshipMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative">
                                    <label for="guardian_contact_no" id="guardianContactNoLabel" class="text-sm mb-2 block 
                                    ...
                                    <p id="guardianContactNoMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                        ...
                        <div id="content4" class="w-full bg-white max-h-[80vh] shadow-lg mt-[-17px] overflow-y-auto sm:pt-2 px-6 py-10 rounded-md lg:px-12" style="display: none;">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
                                <div class="relative md:col-span-4 sm:col-span-3">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="pensionerLabel" class="text-sm text-gray-800">
                                    ...
                                    <p id="pensionerMessage" class="text-xs mt-2 p-1 hidden"></p>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mt-1">
                                        <div class="w-full md:col-span-2 text-gray-800 relative">
                                            ...
                                            <p id="IfPensionerMessage" class="text-xs mt-2 p-1 hidden"></p>
                                        </div>
                                        ...
                                        <div id="source_list" class="md:col-span-2 relative {{ old('pensioner') == 1 ? '' : 'hidden' }}" >
                                            <div class="flex items-center mt-4 mb-2">
                                                ...
                                                <label id="source_label" class="text-sm text-gray-800 block">
                                            ...
                                            <p id="sourceMessage" class="text-xs mt-2 p-1 hidden"></p>

                                            <p id="otherSourceMessage" class="text-xs mt-2 p-1 hidden"></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="relative md:col-span-4 sm:col-span-4"> 
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="permanent_source_label" class="text-sm text-gray-800">
                                    ...
                                    <p id="permanent_source_message" class="text-xs mt-2 p-1 hidden"></p>
                                    ...
                                    <div class="md:grid grid-cols-1 md:grid-cols-4 gap-8 mt-1">
                                        ...
                                        <div id="income_source_list" class="md:col-span-2 relative {{ old('permanent_source') == 1 ? '' : 'hidden' }}" >
                                            <div class="flex items-center mt-4 mb-2">
                                                ...
                                                <label id="income_source_label" class="text-sm text-gray-800 block">
                                                If yes, from what source? <span class="italic">(Kung oo, mula saan?)</span>
                                                </label>
                                            </div>
                                            ...
                                            <p id="income_source_message" class="text-xs mt-2 p-1 hidden"></p>
                                            <p id="other_income_source_message" class="text-xs mt-2 p-1 hidden"></p>
                                        </div>
                                    </div>

                                    <p id="permanent_source_message" class="text-xs mt-2 p-1 hidden"></p>
                                    <p id="IfPermanentIncomerMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
                                <div class="relative md:col-span-3 sm:col-span-3">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="IllnessLabel" class="text-sm text-gray-800">
                                    ...
                                    <p id="illnessMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div class="relative md:col-span-3 sm:col-span-3">
                                    <div class="flex items-center mb-2">
                                        <img id="disability_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <label id="DisabilityLabel" class="text-sm text-gray-800">
                                    ...
                                    <p id="disabilityMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                        </div>

                        <div id="content5" class="w-full bg-white max-h-[80vh] shadow-lg mt-[-17px] overflow-y-auto sm:pt-2 px-6 py-10 rounded-md lg:px-12" style="display: none;">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                                <div x-data="{
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="validIdLabel" class="text-sm block text-gray-800">
                                        Valid ID
                                        </label>
                                    </div>
                                    <input id="valid_id_input" name="valid_id" type="file" accept="image/*"
                                        class="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-3 rounded-md transition-all bg-gray-100 border border-gray-500 focus:ring-blue-500 focus:border-blue-500" 
                                    ...
                                    <p id="validIdMessage" class="text-xs mt-2 p-1 hidden"></p>
                                ...
                                <div x-data="{
                                    ...
                                    <label id="profilePictureLabel" class="text-sm mb-2 block text-gray-800">
                                        Profile Picture
                                    </label>
                                    ...
                                    <p id="profilePictureMessage" class="text-xs mt-2 p-1 hidden"></p>
                                ...
                                <div x-data="{
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="indigencyLabel" class="text-sm block text-gray-800">
                                    ...
                                    <p id="indigencyMessage" class="text-xs mt-2 p-1 hidden"></p>
                                ...
                                <div x-data="{
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="birthCertificateLabel" class="text-sm block text-gray-800">
                                        Birth Certificate
                                        </label>
                                    </div>
                                    ...
                                    <p id="birthCertificateMessage" class="text-xs mt-2 p-1 hidden"></p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                                <div class="relative">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="emailLabel" class="text-sm text-gray-800">
                                            Email Address
                                        </label>
                                    </div>
                                    <input name="email" id="email_register" type="email" 
                                        class="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-3 rounded-md transition-all bg-gray-100 border-gray-500 focus:ring-blue-500 focus:border-blue-500" 
                                        placeholder="Enter email" value="{{ old('email') }}" />
                                    
                                    <p id="emailMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>

                                <div>
                                    <div class="flex items-center mb-2">
                                        <img id="password_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <label id="passwordLabel" class="text-sm text-gray-800">
                                        Password
                                        </label>
                                    </div>
                                    <div class="relative">
                                        ...
                                        <p id="passwordMessage" class="text-xs mt-2 p-1 hidden"></p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="confirmPasswordLabel" class="text-sm text-gray-800">
                                        Confirm Password
                                        </label>
                                    </div>
                                    <div class="relative">
                                    ...
                                    <p id="confirmPasswordMessage" class="text-xs mt-2 p-1 hidden"></p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                                 <div x-data="{
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label id="signatureLabel" class="text-sm text-gray-800">
                                            Signature
                                        </label>
                                    </div>
                                    ...
                                    <p id="signature_filename" class="text-gray-700 text-xs mt-2"></p>
                                    ...
                                    <p id="signatureMessage" class="text-xs mt-2 p-1 hidden"></p>
                            ...
                            <div class="row justify-content-center align-items-center mt-8"> 
                                <div class="col-md-12 text-left"> 
                                    <div class="checkbox-container flex justify-center items-center gap-2">
                                        <img id="checkbox_asterisk" src="images/asterisk.png" alt="Asterisk" class="w-3 h-3 mr-2" style="display: block">
                                        <input 
                            ...
                            <div class="mt-8 flex justify-center">
                                <button type="submit" id="submit" name="submit" class="py-3 px-6 md:w-auto text-sm tracking-wider font-light rounded-md text-white bg-blue-500 hover:scale-105 transition duration-150 ease-in-out focus:outline-none">
                                    Sign up
                                </button>
                            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const validIconBirthdate = document.getElementById("validIconBirthdate");
    const invalidIconBirthdate = document.getElementById("invalidIconBirthdate");
    const birthdateMessage = document.getElementById("birthdateMessage");

    function validateBirthdate() {
        const value = birthdateInput.value.trim();
        birthdateIcon.classList.remove("hidden");
        ...
        if (birthdate > today) {
            ...
            validIconBirthdate.classList.add("hidden");
            invalidIconBirthdate.classList.remove("hidden");
        } else {
            ...
            birthdateMessage.textContent = "Looks good!";
            birthdateMessage.classList.remove("text-red-500", "hidden");
            birthdateMessage.classList.add("text-green-500");
            validIconBirthdate.classList.remove("hidden");
            invalidIconBirthdate.classList.add("hidden");
        }
        ...
        if (value === "") {
            ...
            birthdateMessage.classList.add("hidden");
            birthdateIcon.classList.add("hidden");
        }
    }
    ...
    function validateAge() {
        ...
        if (isNaN(age) || age < 60) {
            ...
            ageMessage.textContent = "Looks good!";
